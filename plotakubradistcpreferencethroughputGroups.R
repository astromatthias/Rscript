...
sample2 = read.csv(file="/home/mhn/Dokumente/Fedora_Performance_Test/throughput_managed_referenced_sample_2.csv", head=TRUE, sep="\t")
sample3 = read.csv(file="/home/mhn/Dokumente/Fedora_Performance_Test/throughput_managed_referenced_sample_3.csv", head=TRUE, sep="\t")
sample4 = read.csv(file="/home/mhn/Dokumente/Fedora_Performance_Test/throughput_managed_referenced_sample_4.csv", head=TRUE, sep="\t")

# ohne diese Zeile würde R den Graph in einem Fenster anzeigen.
png("/home/mhn/Entwicklung/R/vortrag/graphiken/throughput_akubra_distcp-referenced_samples.png")
...
legend("topleft", inset=.05, title="Managed vs. Referenced(+distcp) content",
